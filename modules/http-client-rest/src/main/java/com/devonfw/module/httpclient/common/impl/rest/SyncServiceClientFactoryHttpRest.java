...
public class SyncServiceClientFactoryHttpRest extends SyncServiceClientFactoryHttp {
  ...
  /*
   * @Override protected <S> S createService(ServiceContext<S> context, String url) {
   *
   * ServiceHttpClient client = new ServiceHttpClient(getHttpClient(), url); return
   * SyncServiceHttpClientRest.of(context, client, this); }
   */

 ...
 * {@link SyncServiceClient}{@literal <MyService>} client = factory.{@link ServiceClientFactory#createAsync(Class) createAsync}(MyService.class);
...
public interface SyncServiceClient<S> {
   ...
   *         {@link SyncServiceClient} was {@link ServiceClientFactory#createAsync(Class) created}. It is just a stub
